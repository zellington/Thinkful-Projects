...
questions = {
	"strong": "Do you like yer drinks strong? (y/n)",
	"salty": "Do ye like 'em with a bit 'o salt? (y/n)",
	"sweet": "Would you like a drink as sweet as you, dahhhrrrrrlin? (y/n)",
	"bitter": "Think they're better bitter, my friend? (y/n)",
	"dry": "How 'bout one dry as a desert? (y/n)",
}
ingredients = {
